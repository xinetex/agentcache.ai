...
import { hashPassword, verifyPassword, generateToken, verifyToken, generateApiKey, hashApiKey, verifyApiKey } from './lib/auth.js';
const app = new Hono();
// Environment
...
async function authenticateApiKey(c) {
    if (!db) {
...
// Middleware: JWT auth
async function authenticateJWT(c) {
