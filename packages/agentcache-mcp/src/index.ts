...
if (!API_KEY) console.error('[agentcache-mcp] AGENTCACHE_API_KEY not set — calls will be unauthenticated.');
...
server.setRequestHandler(CallToolRequestSchema, async (request: any) => {
  ...
  try {
    ...
    return await handler(args, { apiKey: API_KEY, request } as any);
  } catch (error: any) {
