 ...
 */
export function validateNamespace(namespace?: string): SecurityValidationResult {
  if (!namespace) {
...
export class QuantumResistantEncryption {
   ...
   */
  static deriveKey(namespace: string, masterKey: string): Buffer {
